(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['module', 'serialize-error', 'socket.io-client'], factory);
    } else if (typeof exports !== "undefined") {
        factory(module, require('serialize-error'), require('socket.io-client'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod, global.serializeError, global.socket);
        global.UneteIO = mod.exports;
    }
})(this, function (module, serializeError, socket_io_client) {
    'use strict';
    ...
    function Socket(sock, functions = {}, with_proxy = true) {
        ...
        function destructureMap(obj) {
            ...
            for (let i in obj) {
                ...
                if (typeof x === "object") base[i] = destructureMap(x);else base[i] = getParamNames(x);
            }
                ...
                Handler = function Handler(cb, base_route = []) {
                    let proxy = new Proxy(function () {}, {
                        ...
                        set(target, prop, value) {
                            ...
                            for (let i = 0, l = value.length - 1; i < l; i++) pointer = pointer[prop];
